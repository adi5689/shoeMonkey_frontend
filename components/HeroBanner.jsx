...
const HeroBanner = () => {
  return (
    <div className='relative text-white text-[20px] w-full max-w-[1360px] mx-auto rounded-md'>
        <Carousel 
            autoPlay={true}
            axis={'vertical'}
            infiniteLoop={true}
            ...
            renderArrowPrev={(clickHandler, hasPrev) => (
                <div
                    ...
                    h-[30px] md:h-[50px] bg-black z-10 flex items-center justify-center cursor-pointer hover:opacity-90 rounded-md'
                >
